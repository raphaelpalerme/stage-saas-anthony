...
- [ ] Personnalise le nom, le logo et les couleurs, puis push
- [ ] Remplace la page d'accueil générique par TA landing : demande à Claude Code de convertir ton `index.html` du jour 5 dans `apps/web/app/[locale]/(marketing)/page.tsx` (prompt prêt dans la Boîte à outils)
