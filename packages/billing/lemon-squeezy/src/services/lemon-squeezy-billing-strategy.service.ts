...
export class LemonSqueezyBillingStrategyService implements BillingStrategyProviderService {
  ...
  async getSubscription(subscriptionId: string) {
    ...
    // the interval from the variant's configured billing interval (stable plan
    // metadata), consistent with the webhook handler. Inferring it from the
    // renewal date misclassifies annual plans as monthly near renewal.
